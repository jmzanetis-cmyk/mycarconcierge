...
async function draftMessageWithAI(lead, channel, sequenceStep) {
  try {
    ...
    if (sequenceStep === 1) {
      ...
      followUpNote = 'This is the FINAL follow-up (#3). Use real social proof: mention that My Car Concierge is actively raising on Wefunder (wefunder.com/my.car.concierge) — investors are already backing this platform, which means it is growing whether or not they join. Create genuine urgency — founding partner spots carry real perks that will not be available once the platform is established. Keep it concise and respectful of their time. Make it clear this is the last message unless they respond.';
    }
