    ...
    // SMS-based 2FA was removed 2026-09-22. Zero users were enrolled (verified via
    // auth.mfa_factors: 0 SMS factors, 1 unverified TOTP), the handlers
    // /api/2fa/send-code and /api/2fa/verify-code do not exist in netlify/functions/,
    // and the pending2faUser variable was never assigned a real value. TOTP-based
    // 2FA lives below (pendingTotpUser + verifyTotpCode + backup codes).
