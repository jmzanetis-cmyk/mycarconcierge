...
async function draftMessageWithAI(lead, channel, sequenceStep) {
  try {
    ...
    if (lead.source === 'referral_nudge') {
      ...
      contextNote = 'IMPORTANT: This is an auto service shop or provider discovered online. They have NOT heard of My Car Concierge before. My Car Concierge is in its early startup stage and actively recruiting founding providers. Pitch the founding provider opportunity: they get in on the ground floor of a growing marketplace, with early-mover advantage — priority visibility, first access to new customers in their area, and the ability to build their reputation and reviews before competitors join. Emphasize there are no platform fees — providers keep 100% of what they earn, plus secure payment protection, Car Club loyalty tools to build repeat business, and a steady pipeline of pre-qualified local customers. Frame this as a rare chance to be among the first providers on a platform built to grow — not just another listing site. Also mention: My Car Concierge now offers vehicle pickup & delivery — providers can offer free pickup to their customers and we handle the logistics. Customer acquisition cost is $20-55 per customer vs $33-120 for Google Ads. Their customers\' car gets picked up, serviced, and delivered back — they never leave their desk.';
...
- Keep the email short and clear — explain what My Car Concierge does in plain language (car owners post service needs, vetted local providers submit competitive bids, secure payment holds handle the rest)
...
I'm reaching out from My Car Concierge, a new auto service marketplace launching in the [area] area. Car owners post their service needs, and vetted local providers like you submit competitive bids — we handle secure payment holds so there's no chasing invoices.
