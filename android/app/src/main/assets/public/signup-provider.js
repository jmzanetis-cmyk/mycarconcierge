    ...
    async function submitApplication() {
      ...
      try {
        ...
        const applicationPayload = {
          ...
          years_in_business: Number.parseInt(document.getElementById('years-business').value) || 0,
          employees_count: document.getElementById('employees').value ? Number.parseInt(document.getElementById('employees').value) : null,
          bays_count: document.getElementById('bays').value ? Number.parseInt(document.getElementById('bays').value) : null,
          vehicles_per_week: document.getElementById('capacity').value ? Number.parseInt(document.getElementById('capacity').value) : null,
          has_loaner_vehicles: hasLoaner,
          loaner_vehicle_count: hasLoaner && document.getElementById('loaner-count').value ? Number.parseInt(document.getElementById('loaner-count').value) : null,
          ...
          loaner_fee_amount: hasLoaner && document.getElementById('loaner-fee-amount').value ? Number.parseFloat(document.getElementById('loaner-fee-amount').value) : null,
          pickup_delivery_options: pickupDeliveryOptions.length ? pickupDeliveryOptions : null,
          pickup_radius_miles: document.getElementById('pickup-radius').value ? Number.parseInt(document.getElementById('pickup-radius').value) : null,
          pickup_fee_type: document.getElementById('pickup-fee').value,
          pickup_fee_amount: document.getElementById('pickup-fee-amount').value ? Number.parseFloat(document.getElementById('pickup-fee-amount').value) : null,
