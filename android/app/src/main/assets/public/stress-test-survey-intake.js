...
const STRESS_TAG = process.env.STRESS_TAG || `stress-survey-${Date.now()}`;
...
async function cleanup() {
  ...
  // zero leftover survey_responses rows for this run.
  writeStressManifest({ test: 'survey-intake', stress_tag: STRESS_TAG });
