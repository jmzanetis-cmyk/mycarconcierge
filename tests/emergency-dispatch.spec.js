...
async function addProviderFunctionStubs(page) {
  await page.addInitScript(() => {
    ...
    globalThis.loadNearbyEmergencies = asyncNoop;
    globalThis.loadMyActiveEmergency = asyncNoop;
    ...
    globalThis.loadProviderAnalytics = asyncNoop;
    globalThis.loadEarningsAnalytics = asyncNoop;
    globalThis.loadEarningsAnalyticsData = asyncNoop;
    globalThis.initEarningsAnalytics = asyncNoop;
    globalThis.loadAdvancedAnalytics = asyncNoop;
...
test.describe('Member Emergency Request', () => {
  ...
  test('Emergency price preview calculates for tow service', async ({ page }) => {
    ...
    const ratesExist = await page.evaluate(() => {
      return typeof globalThis.EMERGENCY_SERVICE_RATES !== 'undefined' ||
