...
*Version reference: submitting from commit `edcfc0d50ffaba8a07a7bb09b9cfeba12e83b70f` — CFBundleShortVersionString `[FILL IN — target 1.1.0 or bump]`, CFBundleVersion `[FILL IN — target 18 or higher, current 17 was built but not installed]`.*
...
- [ ] **Rebuild the archive from commit `edcfc0d50ffaba8a07a7bb09b9cfeba12e83b70f`** with `CFBundleVersion` bumped to `[FILL IN — 18 or next after last submitted]` and `CFBundleShortVersionString` `[FILL IN — 1.1.0 or bumped if minor changes]`.
